...
import it.tss.postit.business.entity.Postit;
import presentation.util.JsfUtil;
import presentation.util.JsfUtil.PersistAction;
import it.tss.postit.business.boundary.PostitFacade;
...
public class PostitController implements Serializable {
    ...
    @EJB
    private it.tss.postit.business.boundary.PostitFacade ejbFacade;
    ...
    public Postit getPostit(java.lang.Long id) {
